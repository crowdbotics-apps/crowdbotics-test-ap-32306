...
## Project Structure
    ...
    ├── crowdbotics_test_ap_32306  # Django project configurations
...
1. Clone this repo and `cd crowdbotics_test_ap_32306`
...
2. Clone this repo and `cd crowdbotics_test_ap_32306`
